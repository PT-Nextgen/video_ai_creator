...
DEFAULT_PROMPT = {
    "positive_prompt": structured_prompt_entry("T2VA", en=empty_structured_prompt("T2VA")),
...
def build_minimax_h3_t2v_workflow(
    ...
    return build_workflow(t2v_prompt, scene_meta=scene_meta, duration_override=duration_override)
