...
Portable to any agent that can read local files; no external API calls, MiniMax Hub tools, or proprietary runtime are required. The optional `agents/openai.yaml` only provides UI metadata.
